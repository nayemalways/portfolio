            ...
            <section id='contact' className='py-5'>
                <div style={{height: '100vh'}} className="container">
                    <div className="row d-flex justify-content-center align-items-center">
                        ...
                        <div className="col-md-6 text-start p-5 rounded rounded-4 ">
                            <h2 data-aos="fade-bottom" className='h1_color fw-bold text-center '>Get in touch</h2>
                            <form data-aos="fade-up-bottom" id='form' action="https://formspree.io/f/movjyqae" method='POST'>
                                <div className='pt-3'>
